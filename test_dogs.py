...
with sync_playwright() as p:
    ...
    page.get_by_role("button", name="23 September 2026", exact=True).click()
    ...
    # NEW: screenshot BEFORE submitting, to check the dog count actually shows 2
    page.screenshot(path="debug_dogcount.png", full_page=True)

    page.get_by_test_id("selectWrapper").get_by_test_id("submit").click()
    page.get_by_test_id("submit").click()
    page.wait_for_timeout(4000)
    page.screenshot(path="debug_23sept_v2.png", full_page=True)
